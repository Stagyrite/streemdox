...
The Streem documentation is available below. It covers not only
basic usage and standard library, but also math, CSV parser, hashtable,
and more.
...
1. [strings](doc/strings.md)
1. [iterative programming](doc/iter.md)
...
1. [statistics](library/stat.md)
1. [key-value store](library/kvs.md)
1. [comma-separated value (CSV)](library/csv.md)
